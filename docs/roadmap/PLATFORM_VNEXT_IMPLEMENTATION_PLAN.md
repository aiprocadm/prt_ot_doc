...
Дальше по контуру: фильтр в СИЗ/обучении/документах, согласие клиента на
делегированный доступ (разд. 66), делегированный доступ к своему контуру
клиента (только он снимет `not_aggregated`), перевод Lightweight→Dedicated
