...
**Summary (updated 2026-07-04 sync):** **3 subprojects fully merged** (P10-05 Подрядчики, P10-08 Наряды-допуски, P10-04 СОУТ срезы 1-6) · **9 partial** (P10-01/02/03/06/07/09/10/12/14 — P10-10 workflow-движок перемещён из «not started» в «partial» по сверке кода 2026-07-04) · **3 not started** (P10-11/13/15). P10-04 СОУТ закрыт по всем 6 срезам (PR #696–#710). P10-06 СИЗ-склад дополнен журналом движений + FIFO-списанием (PR #720), затем инвентаризацией/перемещениями/поставщиками (PR #722/#724/#725) и мобильной выдачей (online-first `/ppe/issue`). Next-up by version tag `[v1.1]`: finish partials — **P10-03 медосмотры** (контингент/психиатрия/направления/отстранение), **P10-06 СИЗ-склад** (бюджет безопасности), **P10-07 analytics** (управленческие дашборды + report-builder UI); **P10-10** (rules-engine + визуальный редактор + smart recommendations поверх готового workflow-движка); then not-started **P10-13 SSO**, P10-11 вертикали, P10-15 терминалы/CV/AI.
