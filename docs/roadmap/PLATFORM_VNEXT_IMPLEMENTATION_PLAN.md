...
Дальше по контуру: остальные запреты имперсонации и срок жизни контекста
(Доп. №3 63.2), фильтр в СИЗ/обучении/документах, делегированный доступ к
своему контуру клиента (только он снимет `not_aggregated`), перевод
Lightweight→Dedicated без потери истории (49.1).
