...
| Phase 5: Document Factory Hardening | P2 | Template engine, header/footer, replace engine improvements | 2-3 sessions | 🟡 IN PROGRESS (5.1 acceptance: 4/5 done — Session 36 linter + inspector + 53 tests, Session 37 migration audit + 14 tests + CLI; remaining: preview-parity proof) |
...
**Estimated:** 1.5 sessions (Sessions 36 + 37 done; remaining: preview-parity proof, frontend inspector UI — both deferred to follow-up sessions)
