...
8. **#32 `pack_safety_summary` ignores `pack_run_id`** (`routes/packs/run.py:447`). Returns up to 100 unrelated tenant persons and never validates the run. Needs scoping to the run's persons + a 404 on unknown run.
