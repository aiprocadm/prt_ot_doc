...
> **DEPRECATED (2026-05-04).** Канонический и машинно-проверяемый трекер MVP-требований — [`docs/audit/TZ_COVERAGE_MATRIX.md`](audit/TZ_COVERAGE_MATRIX.md). Этот файл — историческая навигационная матрица; новых требований сюда не добавлять, для приёмки не использовать (см. `docs/CLEANUP_CANDIDATES.md` → Wave 4).
