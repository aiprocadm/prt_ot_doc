...
подъёмов инструментов разработки — ВСЕ сделаны (typescript-eslint 8 — срез-221; `vitest` 4 и `vite` 8 — срез-220; `pytest` 9 — сделано, срез-219; (`black` 26 снят с повестки: пакет убран, срез-218)
