...
class WorkflowDefinitionVersion(TenantBaseModel, SoftDeleteMixin):
    ...
    status: Mapped[WorkflowDefinitionStatus] = mapped_column(Enum(WorkflowDefinitionStatus, name="workflowdefinitionstatus"), nullable=False, default=WorkflowDefinitionStatus.DRAFT)
...
class WorkflowInstance(TenantBaseModel, SoftDeleteMixin):
    ...
    status: Mapped[WorkflowInstanceStatus] = mapped_column(Enum(WorkflowInstanceStatus, name="workflowinstancestatus"), nullable=False, default=WorkflowInstanceStatus.RUNNING)
...
class WorkflowTask(TenantBaseModel, SoftDeleteMixin):
    ...
    status: Mapped[WorkflowTaskStatus] = mapped_column(Enum(WorkflowTaskStatus, name="workflowtaskstatus"), nullable=False, default=WorkflowTaskStatus.OPEN)
