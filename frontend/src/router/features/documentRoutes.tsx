...
export const documentReadRoutes = (): ReactElement[] => [
  ...
  />,
  <Route
    key="/approvals/outbox"
    path="/approvals/outbox"
    element={<ApprovalsOutboxPage />}
  />,
  <Route
    key="/approval-routes"
  ...
  />,
  <Route
    key="/pipelines/runs/:id"
    path="/pipelines/runs/:id"
    element={<PipelineRunDetailsPage />}
  />,
  ...
  />,
  <Route
    key="/package-profiles"
    path="/package-profiles"
    element={<PackageProfilesPage />}
  />,
  <Route
    key="/package-presets"
    path="/package-presets"
    element={<PackagePresetsPage />}
  />,
  <Route
    key="/generate-pack/:presetId"
    path="/generate-pack/:presetId"
    element={<GeneratePackWizardPage />}
  />,
  <Route
    key="/pack-runs/:id"
    path="/pack-runs/:id"
    element={<PackRunDetailsPage />}
  />,
];

export const documentCreateRoutes = (): ReactElement[] => [
  <Route
    key="/documents/wizard"
    path="/documents/wizard"
    element={<DocumentsWizardPage />}
  />,
  <Route
    key="/documents/quick-generate"
    path="/documents/quick-generate"
    element={<QuickGeneratePage />}
  />,
  <Route
    key="/generation"
    path="/generation"
