...
export const contractorsApi = {
  ...
  ): Promise<ContractorRegistryPage> {
    const { data } = await apiClient.get<ContractorRegistryPage>(
      `${BASE}/registry`,
      {
  ...
  async getRegistry(id: string): Promise<ContractorRegistry> {
    return (await apiClient.get<ContractorRegistry>(`${BASE}/registry/${id}`))
      .data;
  },
  async createRegistry(
    payload: ContractorRegistryCreate,
  ): Promise<ContractorRegistry> {
    return (
      await apiClient.post<ContractorRegistry>(`${BASE}/registry`, payload)
    ).data;
  },
  async updateRegistry(
    ...
    return (
      await apiClient.patch<ContractorRegistry>(
        `${BASE}/registry/${id}`,
        payload,
      )
    ).data;
  ...
  // ── Employees ─────────────────────────────────────────────────────────
  async listEmployees(
    params: { contractor_id?: string } = {},
  ): Promise<ContractorEmployeePage> {
    const { data } = await apiClient.get<ContractorEmployeePage>(
      `${BASE}/employees`,
      { params },
    );
  ...
  async createEmployee(
    payload: ContractorEmployeeCreate,
  ): Promise<ContractorEmployee> {
    return (
      await apiClient.post<ContractorEmployee>(`${BASE}/employees`, payload)
    ).data;
  },
  async updateEmployee(
    ...
    return (
      await apiClient.patch<ContractorEmployee>(
        `${BASE}/employees/${id}`,
        payload,
      )
    ).data;
  ...
  async getEmployeeReadiness(id: string): Promise<AdmissionVerdict> {
    return (
      await apiClient.get<AdmissionVerdict>(`${BASE}/employees/${id}/readiness`)
    ).data;
  },
  async getEmployeeChecklist(id: string): Promise<DocumentChecklist> {
    return (
      await apiClient.get<DocumentChecklist>(
        `${BASE}/employees/${id}/document-checklist`,
      )
    ).data;
  },
  async admitEmployee(id: string): Promise<AdmissionVerdict> {
    return (
      await apiClient.post<AdmissionVerdict>(`${BASE}/employees/${id}/admit`)
    ).data;
  },
  ...
  async listIncidents(
    params: { contractor_id?: string } = {},
  ): Promise<ContractorIncidentPage> {
    const { data } = await apiClient.get<ContractorIncidentPage>(
      `${BASE}/incidents`,
      { params },
    );
    return { items: data.items ?? [], total: data.total ?? 0 };
  ...
  async createIncident(
    payload: ContractorIncidentCreate,
  ): Promise<ContractorIncident> {
    return (
      await apiClient.post<ContractorIncident>(`${BASE}/incidents`, payload)
    ).data;
  },
  ...
  async getComplianceSummary(
    ...
    return (
      await apiClient.get<ContractorComplianceSummary>(
  ...
  ): Promise<ContractorDocumentPage> {
    const { data } = await apiClient.get<ContractorDocumentPage>(
      `${BASE}/documents`,
      { params },
    );
    return { items: data.items ?? [], total: data.total ?? 0 };
  ...
  async listExpiringDocuments(
    ...
    const { data } = await apiClient.get<ContractorDocumentPage>(
      `${BASE}/documents/expiring`,
      { params },
    );
    return { items: data.items ?? [], total: data.total ?? 0 };
  },
  async getDocument(id: string): Promise<ContractorDocument> {
    return (await apiClient.get<ContractorDocument>(`${BASE}/documents/${id}`))
      .data;
  },
  async createDocument(
    ...
    return (
      await apiClient.post<ContractorDocument>(`${BASE}/documents`, payload)
    ).data;
  },
  async updateDocument(
    ...
    return (
      await apiClient.patch<ContractorDocument>(
        `${BASE}/documents/${id}`,
        payload,
      )
    ).data;
  ...
  async listRequirements(): Promise<ContractorDocumentRequirementPage> {
    const { data } = await apiClient.get<ContractorDocumentRequirementPage>(
  ...
  ): Promise<ContractorDocumentRequirement> {
    return (
      await apiClient.post<ContractorDocumentRequirement>(
        `${BASE}/document-requirements`,
        payload,
      )
    ).data;
