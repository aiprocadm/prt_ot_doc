...
export const ReplaceStep = memo(({
  ...
  onReplaceMapChange,
  onDryRun,
}: Pick<SharedProps, "canCallApi" | "docxFile" | "replaceMapFile" | "replaceDryRunResult" | "setDocxFile"> & {
  ...
  <div className="space-y-3">
    ...
    <Button disabled={!canCallApi || !docxFile || !replaceMapFile} onClick={() => void onDryRun()}>
      Выполнить dry-run
    </Button>
...
export const RunStep = ({
  ...
  <div className="space-y-3">
    ...
    <div className="flex flex-wrap gap-2">
      <Button disabled={!canCallApi || !sourceFile || !templateCode || !companyId} onClick={() => void onRunBatch()}>
...
export const BatchResultStep = memo(({
  ...
  batchErrors,
  setBatchErrors,
}: Pick<SharedProps, "rowStatusFilter" | "setPartial" | "batch" | "filteredBatchItems" | "batchErrors" | "setBatchErrors">) => (
  <div className="space-y-3">
