      ...
      <div className="mx-auto flex h-16 w-full max-w-7xl items-center gap-2 px-4">
        ...
        <div className="flex shrink-0 items-center gap-1 sm:gap-2">
          ...
          <Button
            ...
            variant="ghost"
            size="icon"
            aria-label="Единый реестр задач"
          ...
          >
            ...
            >
              ...
              <Badge
                variant="destructive"
                className="absolute -right-1 -top-1 hidden h-5 min-w-[20px] items-center justify-center rounded-full px-1 text-[10px] sm:flex"
              >
                {kpi.alerts}
              </Badge>
            </Link>
