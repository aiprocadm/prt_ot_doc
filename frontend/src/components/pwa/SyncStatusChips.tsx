...
import { AlertCircle, CheckCircle2, Clock3, RefreshCw, WifiOff } from "lucide-react";
...
const variantByState: Record<SyncState, "default" | "secondary" | "destructive" | "outline"> = {
  online: "default",
  queued: "secondary",
  syncing: "outline",
...
export const SyncStatusChips = ({ state }: { state: SyncState }) => (
  <div className="flex items-center gap-2">
    <Badge variant={variantByState[state]} className="inline-flex items-center gap-1">
      {iconByState[state]}
      {state}
    </Badge>
