"""SEC-65 хвост: RLS для реестра транспортных средств (создан в rs01).
...
Revision ID: 20260828_sec65_rls_vehicles
Revises: 20260828_rs01_vehicles
...
revision = "20260828_sec65_rls_vehicles"
down_revision = "20260828_rs01_vehicles"
branch_labels = None
depends_on = None

_TABLES = ("road_vehicle",)
