"""SEC-65 хвост: RLS для fire_maintenance (создана в fs04).
...
Паттерн — как в fire_drill: ENABLE + FORCE + policy tenant_isolation
(PG-only, SQLite не умеет RLS).

Revision ID: 20260824_sec65_rls_fire_maint
Revises: 20260824_fs04_fire_maintenance
...
revision = "20260824_sec65_rls_fire_maint"
down_revision = "20260824_fs04_fire_maintenance"
branch_labels = None
depends_on = None

_TABLE = "fire_maintenance"
