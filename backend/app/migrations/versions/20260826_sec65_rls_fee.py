"""SEC-65 хвост: RLS для таблиц платы за НВОС (созданы в eco07).
...
Revision ID: 20260826_sec65_rls_fee
Revises: 20260826_eco07_fee
...
revision = "20260826_sec65_rls_fee"
down_revision = "20260826_eco07_fee"
branch_labels = None
depends_on = None

_TABLES = ("nvos_fee_rate", "nvos_fee_line")
