"""rs02: выдача модуля «БДД» существующим (Доп. №1 разд. 56.2).

Модуль ``road_safety`` появился в каталоге продаваемых, а тариф «Всё
...
fs01, is02, eco02 и cd02 для предыдущих дисциплин.

**Кому включаем.** Тем, у кого включены ВСЕ тринадцать прежних продаваемых
...
Revision ID: 20260828_rs02_road_safety_grant
Revises: 20260828_sec65_rls_vehicles
...
revision = "20260828_rs02_road_safety_grant"
down_revision = "20260828_sec65_rls_vehicles"
branch_labels = None
depends_on = None
...
#: шага (тот же довод, что в fs01, eco02 и cd02).
_PREVIOUS_CATALOG = (
    "managed_clients",
    "committees",
    "contractors",
