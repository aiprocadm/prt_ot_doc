"""SEC-65 хвост: RLS для таблиц ПЭК — план-график и замеры (созданы в eco05).
...
Revision ID: 20260826_sec65_rls_pek
Revises: 20260826_eco05_pek
...
revision = "20260826_sec65_rls_pek"
down_revision = "20260826_eco05_pek"
branch_labels = None
depends_on = None

_TABLES = ("emission_monitoring_plan", "emission_measurement")
