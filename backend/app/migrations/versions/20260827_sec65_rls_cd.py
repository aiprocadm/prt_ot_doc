"""SEC-65 хвост: RLS для таблиц формирований ГО и ЧС (созданы в cd01).
...
Revision ID: 20260827_sec65_rls_cd
Revises: 20260827_cd01_formations
...
revision = "20260827_sec65_rls_cd"
down_revision = "20260827_cd01_formations"
branch_labels = None
depends_on = None

_TABLES = ("cd_formation", "cd_formation_member")
