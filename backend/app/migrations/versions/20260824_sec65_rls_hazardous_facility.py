"""SEC-65 хвост: RLS для hazardous_facility (создана в is01).
...
Паттерн — как в fire_document: ENABLE + FORCE + policy tenant_isolation
(PG-only, SQLite не умеет RLS).

Revision ID: 20260824_sec65_rls_opo
Revises: 20260824_is01_hazardous_facility
...
revision = "20260824_sec65_rls_opo"
down_revision = "20260824_is01_hazardous_facility"
branch_labels = None
depends_on = None

_TABLE = "hazardous_facility"
