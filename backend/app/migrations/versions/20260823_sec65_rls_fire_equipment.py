"""SEC-65 хвост: RLS для fire_safety_equipment (создана в fs02).
...
Паттерн — как в committee_invitation: ENABLE + FORCE + policy tenant_isolation
(PG-only, SQLite не умеет RLS).

Revision ID: 20260823_sec65_rls_fire_equipment
Revises: 20260823_fs02_fire_equipment
...
revision = "20260823_sec65_rls_fire_equipment"
down_revision = "20260823_fs02_fire_equipment"
branch_labels = None
depends_on = None

_TABLE = "fire_safety_equipment"
