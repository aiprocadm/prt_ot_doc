"""eco02: выдача модуля «Экология» существующим (Доп. №1 разд. 55).

Модуль ``ecology`` появился в каталоге продаваемых, а тариф «Всё
...
fs01 и is02 для предыдущих дисциплин.

**Кому включаем.** Тем, у кого включены ВСЕ одиннадцать прежних продаваемых
...
Revision ID: 20260825_eco02_ecology_grant
Revises: 20260825_sec65_rls_nvos
...
revision = "20260825_eco02_ecology_grant"
down_revision = "20260825_sec65_rls_nvos"
branch_labels = None
depends_on = None
