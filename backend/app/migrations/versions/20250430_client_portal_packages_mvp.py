...
client_request_ticket_status = postgresql.ENUM(
    ...
    "resolved",
    "closed",
    name="clientrequestticketstatus",
    create_type=False,
)
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_package_runs_status_updated", "package_runs", ["tenant_id", "status", "updated_at"]
    )
