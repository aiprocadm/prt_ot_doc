...
class Contract(TenantBaseModel, SoftDeleteMixin):
    ...
    status: Mapped[ContractStatus] = mapped_column(
        native_enum(ContractStatus, name="contractstatus"), nullable=False, default=ContractStatus.DRAFT
    )
...
class Invoice(TenantBaseModel, SoftDeleteMixin):
    ...
    status: Mapped[InvoiceStatus] = mapped_column(
        native_enum(InvoiceStatus, name="invoicestatus"), nullable=False, default=InvoiceStatus.ISSUED
    )
