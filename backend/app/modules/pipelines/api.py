...
ReadAccess = Depends(abac(_tenant_resource_id, required_roles=_READ_ROLES, action="read pipelines"))
WriteAccess = Depends(
    abac(_tenant_resource_id, required_roles=_WRITE_ROLES, action="write pipelines")
)
