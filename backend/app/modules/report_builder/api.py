...
_WRITE_ROLES = list(screen_roles("reports.manage"))
...
async def _require_feature(
    ...
    if not enabled:
        await raise_for_disabled_module(
            ...
            disabled_code="REPORT_BUILDER_DISABLED",
            disabled_message="Report builder module is not enabled for this tenant",
        )
