...
UNCLASSIFIED_SOURCES: dict[str, str] = {
    ...
    "compliance_requirement": (
        "Требование реестра: следует из нормативного акта, а не из дисциплины; "
        "к чему относится — роль, площадка или процесс свободной строкой, "
        "дисциплина в записи не хранится"
    ),
}
