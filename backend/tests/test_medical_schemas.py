...
from app.schemas.medical import (
    ContingentItem, ContingentPage, MedicalExamCreate, MedicalExamRead,
    MedicalNormCreate, MedicalReferralCreate, MedicalReferralTransition,
    MedicalSummary, MedicalSuspensionRead,
)
...
def test_exam_read_has_new_fields():
    ...
    assert {"exam_kind", "fitness", "restrictions", "contraindications",
            "referral_id", "medical_org_name"}.issubset(fields)
