...
_SELLABLE_ADDED_LATER = {
    ...
    "industrial_safety",
    # Доп. №1 разд. 55 срез-1 (25.08.2026): третья дисциплина получила
    # содержание — реестр объектов НВОС со своими ручками и экраном. Сдвиг
    # тарифа компенсирует миграция 20260825_eco02_ecology_module_grant.
    "ecology",
    # Доп. №1 разд. 56.1 срез-1 (27.08.2026): контур ГО и ЧС получил первое
    # содержание — реестр нештатных формирований. Сдвиг тарифа компенсирует
    # миграция 20260827_cd02_civil_defense_grant.
    "civil_defense",
    # Доп. №1 разд. 56.2 срез-1 (28.08.2026): контур БДД получил первое
    # содержание — реестр транспортных средств. Сдвиг тарифа компенсирует
    # миграция 20260828_rs02_road_safety_grant.
    "road_safety",
}
