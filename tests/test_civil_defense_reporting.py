...
зависит от вида и масштаба ЧС и от требований органа управления ГОЧС. И не
собирает числа из реестров: формирования и личный состав в системе есть, но
подставлять их в документ платформа пока не умеет ни для одной дисциплины.
"""
