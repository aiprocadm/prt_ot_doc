...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"field": "severity", "op": "exists", "value": False}, False),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"conditions": ["not-a-dict"]}, "invalid_condition"),
