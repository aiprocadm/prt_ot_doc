...
@pytest.mark.anyio
async def test_integration_readiness_summary(async_client, sessionmaker, data_factory, make_auth_headers):
    ...
    response = await async_client.get("/api/v1/integrations/readiness", headers={**headers, "X-Tenant": "test"})
